...
export default function FeedComponent({ feed }) {
    const text = "J.P Morgan's debt to equity ratio has risen by 20% ytd."

    return (
        <div className="flex-grow border-l border-r border-gray-700 max-w-2xl sm:ml-[70px] xl:ml-[455px]">
            ...
            <div className="max-w-2xl sm:ml-[5px] xl:ml-[2px] border-gray-500 bg-gray">
                <div class="h-48 lg:h-auto lg:w-48 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" title="Woman holding a mug"></div>
